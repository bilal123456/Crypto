...
?>
                        ...
                        <div class="col-lg-9">
                            ...
                            $directrafferal = "select sum(commission) as c from customer c inner join rafferal r on c.username = r.rafferalunderusername where c.id='".$id."'";
...
window.location.href = "Dailyrafferalhistory.php";
    });
      });
