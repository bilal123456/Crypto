      ...
      <li>
        <a href="logout.php">
          ...
          <i class="fa fa-angle-left pull-right"></i>
            ...
            <div class="content-wrapper" style="background-color: #2f2f2f;">
                ...
                <!-- Main content -->
                <section class="content" style="background-color: #2f2f2f;">

                          <?php 

                            $sql = "select * from materialimage";
                            ...
                            if(mysqli_num_rows($run)>0)
                            {
                              ...
                              ?>
                           <img src="Admin/Vedio/images/<?php echo $row['name'] ?>" width="300" height="200">
                              <?php
                              }
                            }
