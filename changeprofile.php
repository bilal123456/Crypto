                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                    <input  name="username" value="<?php echo $username; ?>" class="form-control"  id="id_username">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">First Name</label>
                                                    <div class="col-sm-10">
                                                    <input  name="firstname" value="<?php echo $firstname ?>" class="form-control" id="id_first_name">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Last Name</label>
                                                    <div class="col-sm-10">
                                                    <input  name="lastname" value="<?php echo $lastname ?>"  class="form-control" id="id_last_name">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
